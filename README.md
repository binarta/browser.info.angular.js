# browser.info.angular.js

[AngularJS](http://angularjs.org/) module for browser information and feature detection based on the [Binarta](http://binarta.com/) platform.
